...
$qrtitle ='';
//echo $ip;
if(isset($_SESSION['mqr_id'])&& $_SESSION['mqr_id']!=''){
    $rs = mysql_query("SELECT title FROM qr WHERE id='".$_SESSION['mqr_id']."'");
    $rowqr = mysql_fetch_array($rs);
    $qrtitle = $rowqr['title'];
}
//BROWSER
function getBrowser() 
...
//CHECK IP
mysql_query("INSERT INTO scans (client, ip, browser, platform, counter,qrtitle) VALUES('$client', '$ip', '$browser', '$platform', '$aufruf','$qrtitle')");	
