...
echo "
                  ...
                  <h3>Ihr Code:</h3><br /><h2>";
echo $client.$aufruf;
echo "                  </h2>
                  <p>Gültig bis Ende Dezember 2015!</p>";
...
?>
        <a href="http://arredopiu.ch/" class="btn btn-default-red" target="_blank"><i class="fa fa-file-text-o"></i> WEBSEITE</a> </div>
      <!--end .blog-details--> 
    </div>
    <!--end .row--> 
  </div>
