...
//CHECK DOUBLE IP
$result = mysql_query("SELECT ip FROM scans WHERE ip = '$ip' AND client = '$client'");
...
echo "
                  ...
                  <p class=\"bl-sort\">Sie können Ihren Gewinn bei uns einlösen</p>
                  <p>Ihr Code:";
echo $gewinn;
echo "                  </p>
...
?>
                  ...
                  <a href="http://www.jaq-kosmetik.ch" class="btn btn-default-red" target="_blank"><i class="fa fa-file-text-o"></i> WEBSEITE</a> </div>
                <!--end .blog-details--> 
              </div>
              <!--end .row--> 
            </div>
