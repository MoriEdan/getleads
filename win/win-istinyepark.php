...
//CHECK DOUBLE IP
$result = mysql_query("SELECT ip FROM scans WHERE ip='$ip' AND client='$client' AND DATE(scan)=DATE(NOW());");
...
//CHECK IP
mysql_query("INSERT INTO scans (client, ip, browser, platform, counter) VALUES('$client', '$ip', '$browser', '$platform', '$aufruf')");	
...
echo "
                  ...
                  <p class=\"bl-sort\">Sie können Ihren Gewinn in unserem Shop mit folgendem Code einlösen</p>
                  <h3>Ihre Gewinn ID:</h3><br /><h2>";
echo $client.$aufruf;
echo "                  </h2>
                  <p>Gültig bis Ende August 2015!<br />Der Preis muss unter Vorweisung der Gewinner ID abgeholt werden. Und ist weder übertragbar noch kumulierbar.</p>";
...
?>
                  ...
                  <a href="http://www.istinyepark.com/tr/" class="btn btn-default-red" target="_blank"><i class="fa fa-file-text-o"></i> WEBSEITE</a> </div>
                <!--end .blog-details--> 
              </div>
              <!--end .row--> 
            </div>
