...
if(isset($_POST['email_from'])) { 
    ...
    $email_subject = "BESTELLUNG QR Code V2.0";
    ...
    function died($error) { 
		...
		echo "<a href=\"http://www.getleads.ch/qrcode.php\">Back</a>"; 
...
<title>Bestellung QR Code V2.0</title>
<!-- Stylesheets -->
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="contact-details">
              ...
              <p>Wir haben Ihre Nachricht erhalten und werden uns umgehend bei Ihnen melden.</p>
            </div>
            <!-- end .contact-details -->
          </div>
