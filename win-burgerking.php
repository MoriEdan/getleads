...
<div id="main-wrapper">
 ...
 if (($aufruf %10) == 0 )
		...
		echo "<img class=\"\" src=\"img/content/burgerking-menu.jpg\" alt=\"menu gratis\">";

 elseif (($aufruf %5) == 0 ) 

		echo "<img class=\"\" src=\"img/content/burgerking-kaffee.jpg\" alt=\"kaffee gratis\">";

	else

		echo "<img class=\"\" src=\"img/content/burgerking-ice.jpg\" alt=\"ice gratis\">";
...
?>
      ...
      <!--end .row main--> 
      <!-- read older button -->
      <div class="read-older"> <a href="http://www.opsag.ch" class="btn btn-default-red"><i class="fa fa-file-text-o"></i> Weitere Kampagnen</a> </div>
    </div>
    <!--end container--> 
  </div>
