            ...
            <div class="blog-latest">
              <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                  <h5>Wurden Sie zügig bedient?</h5>
                  <p><?php echo $pulse01->buttons('DEMO Wurden Sie zügig bedient?'); ?> </p>
                  <div style="margin:30px"></div>
                  <h5>Konnte man Ihnen helfen?</h5>
                  <p><?php echo $pulse02->buttons('DEMO Konnte man Ihnen helfen?'); ?> </p>
                  <div style="margin:30px"></div>
                  <h5>Wie war die Bedienung?</h5>
                  <p><?php echo $pulse03->buttons('DEMO Wie war die Bedienung?'); ?> </p>
                  <div style="margin:30px"></div>
                  <h5>Wie war die Wartezeit an der Kasse?</h5>
                  <p><?php echo $pulse04->buttons('DEMO Wie war die Wartezeit an der Kasse?'); ?> </p>
                  <a href="http://getleads.ch/win-starbucks.php" class="btn btn-default-red"><i class="fa fa-file-text-o"></i> GEWINN GENERATOR</a> </div>
