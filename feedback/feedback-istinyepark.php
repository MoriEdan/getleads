...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/de_DE/sdk.js#xfbml=1&version=v2.3&appId=1564390893774881";
            ...
            <div class="blog-latest">
              <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                  ...
                  <div style="margin:30px"></div>
                  <a href="http://getleads.ch/win/win-istinyepark.php" class="btn btn-default-red"><i class="fa fa-file-text-o"></i> WIN!</a> </div>
              </div>
              <div style="margin:30px"></div>
              <div class="fb-like" data-href="https://www.facebook.com/istinyepark" data-layout="button" data-action="like" data-show-faces="true" data-share="true"></div>
              <div style="margin:30px"></div>
              <!--end .blog-details--> 
            </div>
