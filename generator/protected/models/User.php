...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, username, password, first_name, last_name, email, auth_code, is_admin, is_active, created_at, is_shop, company,is_companyadmin', 'safe', 'on'=>'search'),
		);
	}
public function beforeSave() {
	...
	public function attributeLabels()
	{
		return array(
			...
			'is_shop' => 'Is Shop',
			'company' => 'Company',
                    'is_companyadmin'=>'Is Company Admin',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('company',$this->company,true);
                $criteria->compare('is_companyadmin',$this->is_companyadmin,true);
